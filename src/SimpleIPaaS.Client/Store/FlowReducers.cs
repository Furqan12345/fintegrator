...
public static class FlowReducers
{
    ...
    public static FlowState ReduceLoadFlowAction(FlowState state, LoadFlowAction action) =>
        new FlowState(isLoading: true, flows: state.Flows, currentFlow: state.CurrentFlow, runResult: state.RunResult);

    [ReducerMethod]
    public static FlowState ReduceLoadFlowResultAction(FlowState state, LoadFlowResultAction action) =>
        new FlowState(isLoading: false, flows: state.Flows, currentFlow: action.Flow, runResult: state.RunResult);
    ...
    public static FlowState ReduceLoadFlowsResultAction(FlowState state, LoadFlowsResultAction action) =>
        new FlowState(isLoading: false, flows: action.Flows.ToList(), currentFlow: state.CurrentFlow, runResult: state.RunResult);
    ...
    public static FlowState ReduceRunFlowAction(FlowState state, RunFlowAction action) =>
        new FlowState(isLoading: true, flows: state.Flows, currentFlow: state.CurrentFlow, runResult: "Running...");

    [ReducerMethod]
    public static FlowState ReduceRunFlowResultAction(FlowState state, RunFlowResultAction action) =>
        new FlowState(isLoading: false, flows: state.Flows, currentFlow: state.CurrentFlow, runResult: action.Result);
        
    [ReducerMethod]
    public static FlowState ReduceUpdateFlowStateAction(FlowState state, UpdateFlowStateAction action) =>
        new FlowState(isLoading: state.IsLoading, flows: state.Flows, currentFlow: action.Flow, runResult: state.RunResult);
}
